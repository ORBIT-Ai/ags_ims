    ...
    return Container(
      child: Row(
        ...
        children: [
          isVerified != null && isVerified
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                splashColor: Styles.badgeColor(isVerified: isVerified)
                    .withAlpha(40),
                icon: Icon(
                  Icons.verified_rounded,
                  color: Styles.badgeColor(isVerified: isVerified),
                  size: 18,
                ),
              ),
            ),
          ...
          isVerified != null && isVerified
              ? SizedBox(
            width: isPopular != null || isPopular ? 8 : 0,
          )
              : Container(),
          isPopular != null && isPopular
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                splashColor:
                Styles.badgeColor(isPopular: isPopular).withAlpha(40),
                icon: Icon(
                  Icons.verified_rounded,
                  color: Styles.badgeColor(isPopular: isPopular),
                  size: 18,
                ),
              ),
            ),
              ...
              : Container(),
          SizedBox(
            width: isReported != null && isReported ? 8 : 0,
          ),
          isReported != null && isReported
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                splashColor: Styles.badgeColor(isReported: isReported)
                    .withAlpha(40),
                icon: Icon(
                  Icons.flag_rounded,
                  color: Styles.badgeColor(isReported: isReported),
                  size: 18,
                ),
              ),
            ),
              ...
              : Container(),
          SizedBox(
            width: isLocked != null && isLocked ? 8 : 0,
          ),
          isLocked != null && isLocked
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                splashColor:
                Styles.badgeColor(isLocked: isLocked).withAlpha(40),
                icon: Icon(
                  Icons.lock_rounded,
                  color: Styles.badgeColor(isLocked: isLocked),
                  size: 18,
                ),
              ),
            ),
              ...
              : Container(),
          SizedBox(
            width: isUnVerified != null && isUnVerified ? 8 : 0,
          ),
          isUnVerified != null && isUnVerified
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                splashColor: Styles.badgeColor(isUnVerified: isUnVerified)
                    .withAlpha(40),
                icon: Icon(
                  Icons.gpp_maybe_rounded,
                  color: Styles.badgeColor(isUnVerified: isUnVerified),
                  size: 18,
                ),
              ),
            ),
    ...
    return Container(
      child: Row(
        ...
        children: [
          ...
          isVerified != null && isVerified
              ? SizedBox(
            width: isPopular != null || isPopular ? 4 : 0,
          )
              : Container(),
          isPopular != null && isPopular
              ? Icon(
            ...
            size: 18,
              ...
              : Container(),
          SizedBox(
            width: isReported != null && isReported ? 4 : 0,
          ),
          isReported != null && isReported
              ? Icon(
            Icons.flag_rounded,
            ...
            size: 18,
              ...
              : Container(),
          SizedBox(
            width: isLocked != null && isLocked ? 4 : 0,
          ),
          isLocked != null && isLocked
              ? Icon(
            Icons.lock_rounded,
            ...
            size: 18,
              ...
              : Container(),
          SizedBox(
            width: isUnVerified != null && isUnVerified ? 4 : 0,
          ),
          isUnVerified != null && isUnVerified
              ? Icon(
            Icons.gpp_maybe_rounded,
  ...
  Widget postBadges({
    ...
    return Container(
      child: Row(
        ...
        children: [
          SizedBox(
            width: isVerified != null && isVerified ? 4 : 0,
          ),
          isVerified != null && isVerified
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isVerified: isVerified),
          ...
          isPopular != null && isPopular
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isPopular: isPopular),
              icon: Icons.verified_rounded,
              ratio: "small",
              function: () {},
              isDesktop: isDesktop)
          ...
          isReported != null && isReported
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isReported: isReported),
          ...
          isUnVerified != null && isUnVerified
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isUnVerified: isUnVerified),
              ...
              : Container(),
          SizedBox(
            width: isPublicPost != null && isPublicPost ? 4 : 0,
          ),
          isPublicPost != null && isPublicPost
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isPublicPost: isPublicPost),
              ...
              : Container(),
          SizedBox(
            width: isFriendOnlyPost != null && isFriendOnlyPost ? 4 : 0,
          ),
          isFriendOnlyPost != null && isFriendOnlyPost
              ? iconButton(
              context: context,
              iconColor:
              Styles.badgeColor(isFriendOnlyPost: isFriendOnlyPost),
              ...
              : Container(),
          SizedBox(
            width: isPrivatePost != null && isPrivatePost ? 4 : 0,
          ),
          isPrivatePost != null && isPrivatePost
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isPrivatePost: isPrivatePost),
              ...
              : Container(),
          SizedBox(
            width: isFeaturedPost != null && isFeaturedPost ? 4 : 0,
          ),
          isFeaturedPost != null && isFeaturedPost
              ? iconButton(
              context: context,
              iconColor: Styles.badgeColor(isFeaturedPost: isFeaturedPost),
