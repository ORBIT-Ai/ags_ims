...
class OnHand extends StatefulWidget {
  final String title = "On Hand";

  const OnHand({Key key}) : super(key: key);

  @override
  _OnHandState createState() => _OnHandState();
}

class _OnHandState extends State<OnHand> {
