...
class MonthlyInventoryReport extends StatefulWidget {
  const MonthlyInventoryReport({
    Key key,
  }) : super(key: key);
  final String title = "Monthly Inventory Report";

  @override
  _MonthlyInventoryReportState createState() => _MonthlyInventoryReportState();
}

class _MonthlyInventoryReportState extends State<MonthlyInventoryReport> {
  ...
  @override
  void initState() {
    _fireStoreDB.getItemSold(collectiveTerm: "monthly").then((soldValue) {
              ...
              print_widget.Table(
                  ...
                  children: [
                    print_widget.TableRow(children: [
                      headlineRow(
                          text:
                              "Date: ${DateFormat.MMMM().format(DateTime.now())} ${_baseUtils.currentYear()}"),
                    ]),
                    print_widget.TableRow(children: [
